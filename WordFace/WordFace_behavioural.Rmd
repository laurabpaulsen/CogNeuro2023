...
# Data
The data uploaded by you to Brightspace has been gathered and can be found through this link XXXXXX.
...
for(i in 1:length(wordface_files)){
  ...
  # load in data file
  tmp_data <- read_csv(___, show_col_types = FALSE) # show_col_types FALSE to suppress output
